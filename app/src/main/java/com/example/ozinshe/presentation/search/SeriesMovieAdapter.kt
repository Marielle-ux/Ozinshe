...
import com.example.ozinshe.data.model.SeriesModel
import com.example.ozinshe.databinding.ItemSeriesRcViewBinding

class SeriesMovieAdapter(
    private val seriesModelVideo: List<SeriesModel.SeriesModelItem.Video>,
    private val context: Context,
    private val onItemClick: SeriesClickMovie
) : RecyclerView.Adapter<SeriesMovieAdapter.SeriesMovieViewHolder>() {

    interface SeriesClickMovie {
        fun onItemClick(item: SeriesModel.SeriesModelItem.Video)
    }

    inner class SeriesMovieViewHolder(private val binding: ItemSeriesRcViewBinding) :
